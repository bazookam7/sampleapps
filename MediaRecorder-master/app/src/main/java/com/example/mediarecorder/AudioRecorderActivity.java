...
//                    File myDirectory = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS);
...
//                    }
                    ...
                    filePath = getExternalFilesDir(Environment.DIRECTORY_DOWNLOADS).getAbsolutePath() +"/"+ audioFile;
                    startAudioRecorder();
                } catch (Exception e) {
